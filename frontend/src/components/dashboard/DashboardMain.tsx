                      ...
                      <div className="flex-wrap gap-9 pt-1 grid grid-cols-5 aspect-video overflow-y-auto custom-scrollbar">
                        {boards && boards.map((board) => (
                          <InkBoardCard 
                            ...
                            onClick={() => setSelectedId(String(board.id || board._id))} 
                          />
                        ))}
                      </div>
        </main>
          ...
          {selectedId && selectedBoard && (
            <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
              ...
              >
                ...
                <div className="mt-auto flex justify-end gap-3 font-sans">
                  <button className="btn btn-ghost btn-outline border-neutral text-base-content">
                    Edit
                  </button>
